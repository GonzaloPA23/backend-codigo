        ...
        try:
            ...
            for detallePedido in detallePedidos:
                ...
                nuevoDetallePedido = DetallePedidoModel(
                    ...
                    subTotal=detallePedido.get("cantidad")
                    * detallePedido.get("precio"),
            ...
            return {"message": "Pedido creado correctamente"}, 201

        except Exception as error:
            conexion.session.rollback()

            return {"message": "Error al crear el pedido", "content": error.args}
